...
import io.runebox.eventbus.collection.ConcurrentSubscriberArrayList
import io.runebox.eventbus.collection.SubscriberArrayList
...
class EventBus @JvmOverloads constructor(
    ...
    private val exceptionHandler: ExceptionHandler = ExceptionHandler { exception -> throw exception },
    ...
    private val subscribers: MutableMap<Class<*>, MutableList<Subscriber>> =
