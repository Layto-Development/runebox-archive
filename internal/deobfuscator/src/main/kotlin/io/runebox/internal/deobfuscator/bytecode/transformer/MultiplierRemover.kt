...
class MultiplierRemover : BytecodeTransformer {
    ...
    override fun run(pool: ClassPool) {
        ...
        Logger.info("Removed $count euclidean multipliers.")
    }
    ...
    private fun MethodNode.solveConstantMath() {
        ...
        analyzer.analyze(cls.name, this)
    ...
    private class Inter : Interpreter<Expr>(ASM6) {
        ...
        override fun copyOperation(insn: AbstractInsnNode, value: Expr): Expr =
            Expr.Var(sourceInterpreter.copyOperation(insn, value.sv))
    ...
    private class EuclideanMultipliers(private val pool: ClassPool) {
        ...
        private class Interpret(private val multipliers: Multipliers) : Interpreter<Valu>(ASM9) {
            ...
            override fun binaryOperation(insn: AbstractInsnNode, value1: Valu, value2: Valu) = Valu.Two(
                src.binaryOperation(
                    insn,
                    value1.v,
                    value2.v
