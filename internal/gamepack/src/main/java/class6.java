...
public class class6 {
   ...
   public static void method48(byte[] var0, int var1, byte[] var2, int var3, int var4) {
      if (var0 == var2) {
         if (var1 == var3) {
            return;
         }
   ...
   public static void method50(int[] var0, int var1, int var2) {
   ...
   public static void method49(int[] var0, int var1, int var2, int var3) {
      if (var2 == 0 && var3 == 0) {
