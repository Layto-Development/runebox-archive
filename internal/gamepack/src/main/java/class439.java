public class class439 {
   public static class396 field3478;
   static int field3479;
   float[] field3476;
   int field3477;

   class439(float[] var1, int var2) {
      this.field3476 = var1;
      this.field3477 = var2;
   }

   public static int method2041(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5, float[] var6) {
      float var8 = 0.0F;
      ...
      float var42 = (Math.abs(var2) + Math.abs(var4)) * (float)(var1 + 1) * class129.field807;
      if (var8 <= var42) {
         return -1;
      } else {
         ...
         if (var1 == 0) {
            ...
            class439 var12 = new class439(var10, var1);
            ...
            int var15 = method2041(var13, var1 - 1, var2, false, var4, false, var45);
            if (var15 == -1) {
               return 0;
            } else {
               boolean var16 = false;
               ...
               for(int var21 = 0; var21 <= var15; ++var21) {
                  ...
                  if (var21 == 0) {
                     var17 = var2;
                     var19 = method2042(var10, var1, var2);
                  ...
                  var18 = method2042(var10, var1, var20);
                  if (var16) {
                     var16 = false;
                     ...
                     float var25 = var17;
                     float var26 = var20;
                     float var27 = method2042(var12.field3476, var12.field3477, var17);
                     float var24;
                     if (Math.abs(var27) < class129.field807) {
                        var24 = var17;
                     } else {
                        float var28 = method2042(var12.field3476, var12.field3477, var20);
                        if (Math.abs(var28) < class129.field807) {
                           var24 = var20;
                        } else {
                           float var29 = 0.0F;
                           float var30 = 0.0F;
                           ...
                           do {
                              ...
                              float var39 = class129.field808 * Math.abs(var26) + 0.0F;
                              ...
                              if (var41) {
                                 ...
                                 var28 = method2042(var12.field3476, var12.field3477, var26);
   ...
   static float method2042(float[] var0, int var1, float var2) {
