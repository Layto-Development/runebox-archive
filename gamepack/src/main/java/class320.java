public class class320 {
	...
	static {
		field2507 = new int[32768];
		for (int var0 = 0; var0 < 32768; ++var0) {
			field2507[var0] = method1707(var0);
		}
		method1709();
	}

	class320() throws Throwable {
	}

	static final int method1707(int var0) {
	...
	static void method1709() {
		if (field2506 == null) {
			...
			for (int var3 = 0; var3 < 65536; ++var3) {
				...
				field2506[var3] = var19 & 16777215;
			}
		}
	}

	public static int method1708(int var0) {
		return 255 - (var0 & 255);
	}

	static int method1710() {
		return class174.field1729;
	}
}
