public abstract class class459 {
    ...
    class459(int var1, int var2) {
        ...
        this.field3155 = var1;
        this.field3153 = 0;
        this.field3154 = var2 >= 0 && var2 <= 27 ? var2 : 0;
        this.field3152 = method2120(this.field3153, this.field3155, this.field3154);
    }

    static double method2120(int var0, int var1, int var2) {
    ...
    public void method2119() {
        if (this.field3153 < this.field3155) {
            ++this.field3153;
            this.field3152 = method2120(this.field3153, this.field3155, this.field3154);
        }
