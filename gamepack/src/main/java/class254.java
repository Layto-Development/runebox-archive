...
public class class254 {
	@ObfInfo(name = "al", desc = "Lpi;")
	public static class258 field2109;
	@ObfInfo(name = "aj", desc = "I", intMultiplier = -953571091)
	static int field2110;
	@ObfInfo(name = "au", desc = "[F")
	float[] field2107;
	@ObfInfo(name = "ae", desc = "I", intMultiplier = -1920274461)
	int field2108;

	@ObfInfo(name = "<init>", desc = "([FI)V")
	class254(float[] var1, int var2) {
		this.field2107 = var1;
		this.field2108 = var2;
	}

	@ObfInfo(name = "au", desc = "([FIFZFZ[FI)I")
	public static int method1346(float[] var0, int var1, float var2, boolean var3, float var4, boolean var5, float[] var6) {
		float var8 = 0.0F;
		...
		float var42 = (Math.abs(var2) + Math.abs(var4)) * (float)(var1 + 1) * class306.field2473;
		if (var8 <= var42) {
			return -1;
		} else {
			...
			if (var1 == 0) {
				...
				class254 var12 = new class254(var10, var1);
				...
				int var15 = method1346(var13, var1 - 1, var2, false, var4, false, var45);
				if (var15 == -1) {
					return 0;
				} else {
					boolean var16 = false;
					...
					for (int var21 = 0; var21 <= var15; ++var21) {
						...
						if (var21 == 0) {
							var17 = var2;
							var19 = method1347(var10, var1, var2);
						...
						var18 = method1347(var10, var1, var20);
						if (var16) {
							var16 = false;
							...
							float var25 = var17;
							float var26 = var20;
							float var27 = method1347(var12.field2107, var12.field2108, var17);
							float var24;
							if (Math.abs(var27) < class306.field2473) {
								var24 = var17;
							} else {
								float var28 = method1347(var12.field2107, var12.field2108, var20);
								if (Math.abs(var28) < class306.field2473) {
									var24 = var20;
								} else {
									float var29 = 0.0F;
									float var30 = 0.0F;
									...
									do {
										...
										float var39 = class306.field2474 * Math.abs(var26) + 0.0F;
										...
										if (var41) {
											...
											var28 = method1347(var12.field2107, var12.field2108, var26);
	...
	@ObfInfo(name = "ae", desc = "([FIFI)F")
	static float method1347(float[] var0, int var1, float var2) {
